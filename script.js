class CraigGame extends Phaser.Scene {
    constructor() {
        super('CraigGame');
    }
    preload(){
        this.load.path = './session2Activity/assets/';
        this.load.image('sectionimage', 'sectionimage.png');
    }
    create(){        
this.graphics = this.add.graphics();
// add shapes
this.graphics.fillStyle(0x92856D, 1); //color, opacity
...
this.textObject = this.add.text(
    0, //x
    550,//y
    "What's up gamers, it's ya boi, back at it", //text
    {
        font: "40px Arial",
        color: "#ff7700",
    } //style
